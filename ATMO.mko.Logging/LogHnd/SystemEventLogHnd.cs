...
namespace ATMO.mko.Logging
{
    public class SystemEventLogHnd : ILogHnd
    {
        ...
        /// mko, 26.9.2017
        /// </summary>
        public bool TraceInEventLogSchreiben = false;
        ...
        {
            if(TraceInEventLogSchreiben)
                log.WriteEntry(string.Format("{0,-20:s}# {1,4}# Trc# {2}.{3}.{4} \"{5}\"", ti.LogDate, ti.User, ti.AssemblyName, ti.TypeName, ti.FunctionName, ti.Message), EventLogEntryType.Information);
        }
