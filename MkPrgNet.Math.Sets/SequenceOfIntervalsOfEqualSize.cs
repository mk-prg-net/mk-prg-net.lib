...
{
    public class SequenceOfIntervalsOfEqualSize : ISequenceOfIntervalsOfEqualSize<long> 
    {
        /// <summary>
        ...
        public SequenceOfIntervalsOfEqualSize(long start, long width, long end = long.MaxValue)
        {
            _start = start;
            _nextStart = start;
            _width = width;
        ...
        public SequenceOfIntervalsOfEqualSize()
        {
        }
