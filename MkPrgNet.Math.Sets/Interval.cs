...
//  Autor.........: Martin Korneffel (mko)
//  Datum.........: 10.12.2018
//  Änderungen....: Verschoben von mko.BI hierher (MkPrgNet.Math.Sets). GetHashCode automatisch erstellen
//                  lassen
//
//</unit_history>
//</unit_header>        
...
namespace MkPrgNet.Math.Sets
{
        ...
        where T : IComparable<T>, new()        
    {
        ...
        {
            var hashCode = -160569978;
            hashCode = hashCode * -1521134295 + base.GetHashCode();
            hashCode = hashCode * -1521134295 + Empty.GetHashCode();
            hashCode = hashCode * -1521134295 + EqualityComparer<T>.Default.GetHashCode(Begin);
    ...
    public static class Interval
    {
        ...
        public static bool Equals(Interval<double> a, Interval<double> b, int accuracy = 15)
        {
            ...
            return System.Math.Round(a.Begin, accuracy) == System.Math.Round(b.Begin, accuracy) && System.Math.Round(a.End, accuracy) == System.Math.Round(b.End);
