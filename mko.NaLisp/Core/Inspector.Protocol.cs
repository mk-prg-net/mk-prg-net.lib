...
namespace mko.NaLisp.Core
{
    public partial class Inspector
    {
        public class ProtocolEntry
        {
            ...
            public ProtocolEntry(INaLisp Current, bool IsCurrentValid, bool IsTreeValid, Type TypeOfEvaluated)
            {
            ...
            public ProtocolEntry(INaLisp Current, bool IsCurrentValid, bool IsTreeValid, Type TypeOfEvaluated, string Description)
            {
                _NaLispTreeNode = Current;
                _TypeOfEvaluated = TypeOfEvaluated;
                _IsCurrentValid = IsCurrentValid;
            ...
            public ProtocolEntry(INaLisp Current, bool IsCurrentValid, bool IsTreeValid, Type TypeOfEvaluated, string Description, IEnumerable<ProtocolEntry> ChildProtocolEntries)
            {
                _NaLispTreeNode = Current;
                _TypeOfEvaluated = TypeOfEvaluated;
                _IsCurrentValid = IsCurrentValid;
            ...
            public INaLisp NaLispTreeNode { get { return _NaLispTreeNode; } }
            INaLisp _NaLispTreeNode;
