...
//
//  Projekt.......: mko.NaLisp
//  Name..........: LowerEqualThen.cs
//  Aufgabe/Fkt...: Kleiner- gleich - Operator
//                  
//
//
//
...
//  Autor.........: Martin Korneffel (mko)
//  Datum.........: 27.10.2015
//  Änderungen....: Verallgemeinert zu einem generischen Typ.
//
//</unit_history>
//</unit_header>        
...
{
    public class LowerEqualThen<T> : OpBase<T>
        where T: IComparable<T>
    {
        public LowerEqualThen(params Core.INaLisp[] Elements)
            : base(Elements) { }

        protected override Core.INaLisp Create(Core.INaLisp[] Elements)
        {
            return new LowerEqualThen<T>(Elements);            
        }
