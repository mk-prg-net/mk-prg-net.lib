...
namespace mko.NaLisp.Lisp
{
    ...
    {
        public Skip(params Core.INaLisp[] Elements)
        {
        ...
        {
            var SkipCount = (Data.ConstVal<int>)EvaluatedElements[0];
            return new Tuple(EvaluatedElements.Skip(1+SkipCount.Value).ToArray());
        }
