...
{
    public class ComposerStrong : mko.RPN.Composer
    {

        public ComposerStrong(mko.RPN.IFunctionNames fn)
            : base(fn) { }
        ...
        {
            return pnL(fn.constInt + fn.NamePrefix +"list", elems.Select(el => Int(el)).ToArray());
        }
        ...
        {
            return rpnL(fn.constInt + fn.NamePrefix + "list", elems.Select(el => rInt(el)).ToArray());
        }
