...
and the requirements for serialization are lower. 
...
Important: Keywords like $[ and string literals should always be seperated by whitespcaces.

Because spaces between words without meaning, the following text is 
...
Keywords are tags for properties, lists and basic functions. A synonym for 
