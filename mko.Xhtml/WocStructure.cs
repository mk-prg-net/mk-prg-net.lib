...
// Stuttgart, den 17.10.2011
//
//  Projekt.......: mkoItXhtml
//  Name..........: WocStructure.cs
//  Aufgabe/Fkt...: Klasse, die den Zugriff auf die Strukturen eines XHTML-
//                  Dokumentes im Kontext von Woc ermöglicht
//
//
//
//
...
{
    public class WocStructure
    {
        


        /// <summary>
        /// Struktur zur Beschreibung einer Überschrift in einem Woc
        /// </summary>
        public class Headline
        {
            ...
            // Name vom Html Anker am Beginn der Überschrift
            public string Anchor { get; set; }

            // Zeilennummer im xhtml, in der die Überschrift beginnt
            public long Line { get; set; }
        }

        /// <summary>
        /// Alle Überschriften in einem Woc.xhtml- Dokument finden, und die 
        ...
        /// 
        /// </summary>
        /// <param name="WocGuid"></param>
        /// <param name="ImgSrcBase"></param>
        /// <param name="doc"></param>
        /// <param name="mapImgSrcToWoc"></param>
        private static void SetImgSrcBaseInWoc(string WocGuid, string ImgSrcBase, XElement doc, List<MapImgSrcWoc> mapImgSrcToWoc)
        {
            // Urls der Bilder ändern
            foreach (XElement img in doc.XPathSelectElements(@".//img"))
            {
                ...
                if (!IsImgSrcInWocFormat(src, WocGuid))
                {                    
                    src = ImgSrcInWocFormat(src, WocGuid);                                        
                }
